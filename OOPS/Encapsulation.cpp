// #include <iostream>
// using namespace std;
//encapsulation is the wrapping up of data and member function which is combining of property and member functions.
// it is also used for data hiding how?? make it private password and balance of class account .
